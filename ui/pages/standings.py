...
class StandingsPage(ctk.CTkFrame):
    ...
    def _load_data(self):
        try:
            ...
            self.after(0, lambda: self._render(driver_data, constructor_data, schedule))
    ...
    def _render(self, driver_data, constructor_data, schedule):
        ...
        if driver_data:
            ...
            ctk.CTkLabel(self.driver_frame, text="No data available",
        ...
        if constructor_data:
            ...
            ctk.CTkLabel(self.constructor_frame, text="No data available",
                         text_color="#555555").pack(pady=20)
